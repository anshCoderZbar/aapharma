...
import { SingleAnalyticalInstrumentMutation } from "rest/analyticalInstruments.";
import { EditAnalyticalInstrumentMutation } from "rest/analyticalInstruments.";

export default function EditAnalyticalInstrument() {
  const { id } = useParams();
  ...
  const singleEquipment = SingleAnalyticalInstrumentMutation(formData);
  const editEquipment = EditAnalyticalInstrumentMutation();
