...
import { AddAnalyticalInstrumentMutation } from "rest/analyticalInstruments.";

export default function AddAnalyticalInstrument() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const addEquipment = AddAnalyticalInstrumentMutation();
