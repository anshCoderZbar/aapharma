...
export default function ScaffoldHopping() {
  ...
  const editSar = EditScaffHoppingMutation();
  const getSar = GetScaffHoppingMutation();
  ...
  return (
    <div className="sbdd_page">
      <PageWrapper slug="scaffold-hopping" name="Scaffold Hopping" />
